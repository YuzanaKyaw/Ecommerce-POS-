                    ...
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li>
                            <a class="text-decoration-none" href="{{route('admin#contactList')}}">
                                <i class="fa-solid fa-comment-dots"></i>Contact Messages</a>
                        </li>
                    </ul>
                </nav>
            </div>
                                ...
                                <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                        <div class="image">
                                            ...
                                            @else
                                                <img class="shadow-sm"
                                                    src="{{asset('storage/'.Auth::user()->image)}}" style="width:50px; height:50px;" alt="">
                                            @endif
                                        </div>
                                        <div class="content">
                                        ...
                                        <div class="account-dropdown js-dropdown">
                                            <div class="info clearfix">
                                                <div class="image">
                                                    <a href="#">
                                                        @if (Auth::user()->image == null)
                                                            @if (Auth::user()->gender == 'female')
                                                                <img src="{{asset('image/female_default.png')}}" class="shadow-sm rounded-circle" alt="">
                                                            @endif
                                                            <img class=" rounded-circle" src="{{asset('image/default_user_profile.png')}}" alt="">
                                                        @else
                                                            <img class="img-thumbnail shadow-sm rounded-circle"
                                                                src="{{asset('storage/'.Auth::user()->image)}}" style="width:72px; height:72px;" alt="">
                                                        @endif
                                                    </a>
                                                </div>
                                                <div class="content">
                                            ...
                                            <div class="account-dropdown__footer">
                                                <form action="{{route('logout')}}" method="POST" class='d-flex justify-content-center'>
                                                    @csrf
                                                    <button class="btn bg-dark col-10" type='submit'>
